...
git clone https://github.com/Sa-Sajjad/manifest.git --depth 1 -b 6 .repo/local_manifests
git clone https://Sa-Sajjad:$ght@github.com/Sa-Sajjad/android_device_xiaomi_lavender -b eleven device/xiaomi/lavender
# sync script
